export const projects = [
  ...
  },
  {
    ...
    description:
      'Classification models (KNN) in R for early heart disease diagnosis, achieving 77.5% accuracy, 79.7% precision, and 75.0% recall on held-out test data. Performed feature selection and preprocessing on a multi-factor clinical dataset to isolate the most predictive patient indicators.',
    tags: ['R', 'JupyterLab', 'Classification'],
    github: null,
    live: null,
  },
  {
